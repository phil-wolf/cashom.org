  ...
  return (
    <div className="min-h-screen bg-white">
      <Seo
        ...
        jsonLd={{"@context":"https://schema.org","@type":"Course","name":"Cannabis Brand Activator Certification","description":"Experiential brand activation training for cannabis brands and hosts.","provider":{"@type":"Organization","name":"CashoM","url":"https://cashom.org/"}}}
      />
      {/* Header */}
