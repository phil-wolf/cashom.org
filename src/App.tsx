...
import CannabisHospitalityApplication from "./pages/CannabisHospitalityApplication";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/cannabis-hospitality-application" element={<CannabisHospitalityApplication />} />
